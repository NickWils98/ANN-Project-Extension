...
def load_datasets_and_loaders_rotation(data_dir, batch_size):
    ...
    val_dataset = RotationDataset(val_dataset)
...
def train_rotation_model(mode, train_loader, val_loader, num_epochs, device, optimizer, criterion):
    ...
    for epoch in range(num_epochs):
        ...
        model_save_path = os.path.join('rotation_32b_10e_001lr', f'rotation_model{epoch}.pth')
    ...
    for batch_rotated_images, labels in val_loader:
        ...
        for img in all_images:
            if counter in image_list:
                ...
                print(f'index: {counter}, true label: {rotated_labels[labelcounter]}, guess: {predicted_class.item()}')
...
if __name__ == '__main__':
    ...
    model_path = os.path.join('rotation_32b_10e_001lr', f'rotation_model{15}.pth')

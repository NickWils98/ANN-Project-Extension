...
def train_model(model, train_loader, val_loader, num_epochs, device, optimizer, criterion):
    ...
    for epoch in range(num_epochs):
        ...
        model_save_path = os.path.join('sceneClass', f'sceneRotated{epoch}.pth')
...
if __name__ == '__main__':
    ...
    rotation_model_path = os.path.join('rotation_32b_10e_001lr', f'rotation_model{15}.pth')
    ...
    model_path = os.path.join('sceneClass', f'sceneRotated{4}.pth')
